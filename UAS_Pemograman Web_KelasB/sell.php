...
<body>
	...
	<div class="container">
  <h1>Sell Form</h1>
  <form name="registration" class="registartion-form" method="POST" action="output2.php">
    <table>
      <tr>
      ...
      <tr>
		...
		<td><input type="number" name="price" id="price"  style="width:95%;" min="1" required></td>
      </tr>
      <tr>
