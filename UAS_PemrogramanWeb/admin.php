...
if(isset($_POST['add_product'])){
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `fruit`(name, price, image) VALUES('$p_name', '$p_price', '$p_image')") or die('query failed');
...
if(isset($_GET['delete'])){
   ...
   $delete_query = mysqli_query($conn, "DELETE FROM `fruit` WHERE id = $delete_id ") or die('query failed');
   if($delete_query){
...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($conn, "UPDATE `fruit` SET name = '$update_p_name', price = '$update_p_price',image = '$update_p_image' WHERE id = '$update_p_id'");
		...
		<div class="logo">
			<h1><a href="index.html">Tropical Fruit Shop</a></h1>
			 ...
			 <ul>
				...
				<li><a href="vproducts.php">PRODUCTS</a></li>
...
<section class="edit-form-container">
   ...
   if(isset($_GET['edit'])){
      $edit_id = $_GET['edit'];
      $edit_query = mysqli_query($conn, "SELECT * FROM `fruit` WHERE id = $edit_id");
